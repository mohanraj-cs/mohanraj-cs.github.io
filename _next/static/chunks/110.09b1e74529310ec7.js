"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[110],{30110:function(e,t,i){i.r(t),i.d(t,{default:function(){return C}});var r=i(85893),n=i(67294),o=i(10508),s=i(98537);var a=o.ZP.nav.withConfig({componentId:"sc-94fb1622-0"})`
  display: flex;
...
`;var l=o.ZP.li.withConfig({componentId:"sc-f1d0af6c-0"})`
...
`;var T=(0,o.ZP)(S.m.nav).withConfig({componentId:"sc-7ec198cc-0"})`
...
`;var y=o.ZP.span.withConfig({componentId:"sc-a718d402-0"})`
  ...
  width: 100%;
  z-index: -1;
`,I=i(96702);var C=e=>{let{toggleStartMenu:t}=e;const i=(0,n.useRef)(null),[a,l]=(0,n.useState)(!1),{sizes:{startMenu:c}}=(0,o.Fg)(),h=(0,I.Z)(c.maxHeight),{height:d}=h.variants?.active??{};return(0,n.useLayoutEffect)((()=>i.current?.focus(f.eS)),[]),(0,r.jsxs)(T,{ref:i,$showScrolling:a,onBlurCapture:e=>{let{relatedTarget:r}=e;const n=r;if(!(n&&i.current?.contains(n))){const e=n===i.current?.nextSibling,r=n?.parentElement===i.current?.nextSibling;e||r?i.current?.focus(f.eS):t(!1)}},onKeyDown:e=>{let{key:i}=e;"Escape"===i&&t(!1)},onMouseMove:e=>{let{clientX:t=0}=e;const{width:r=0}=i.current?.getBoundingClientRect()||{};l(t>r-f.BQ)},...h,...f.LL,children:[(0,r.jsx)(y,{$height:d}),(0,r.jsx)(k,{height:d}),(0,r.jsx)(s.Z,{url:`${f.Sd}/Start Menu`,view:"list",hideLoading:!0,hideShortcutIcons:!0,isStartMenu:!0,loadIconsImmediately:!0,preloadShortcuts:!0,readOnly:!0,skipFsWatcher:!0,skipSorting:!0})]})}},96702:function(e,t,i){var r=i(64358),n=i(34254);t.Z=function(e){let t=!(arguments.length>1&&void 0!==arguments[1])||arguments[1];const i=Math.min(e,(0,n.sI)()-r.bK);return{animate:"active",exit:{height:.75*i+"px",transition:{duration:r.Nb.TASKBAR_ITEM/10,ease:"circIn"}},initial:"initial",transition:{duration:r.Nb.TASKBAR_ITEM,ease:"circOut"},variants:{active:{height:`${i}px`,paddingTop:0},initial:{height:.75*i+"px",paddingTop:t?.5*i+"px":0}}}}}}]);