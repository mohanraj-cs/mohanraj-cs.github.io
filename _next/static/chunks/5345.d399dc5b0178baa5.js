...
`;var q=e=>{let{children:t,nip05:r,onClick:i,picture:a,pubkey:s,userName:c="Unknown"}=e;const l=Y(r,s),[p,d]=(0,o.useState)("");return(0,n.jsxs)(X,{$clickable:Boolean(i),children:[(0,n.jsxs)("div",{onClick:i,children:[a&&(0,n.jsx)("img",{alt:c,onLoad:()=>d(a),src:a,style:p===a?{}:{position:"absolute",visibility:"hidden"}}),(!a||p!==a)&&(0,n.jsx)(H,{}),l&&(0,n.jsx)("div",{className:"verified",title:l,children:(0,n.jsx)(F,{})})]}),(0,n.jsxs)("figcaption",{children:[(0,n.jsx)("span",{children:c}),t]})]})};var ee=e=>{let{lastEvent:t,onClick:r,pubkey:i,publicKey:a,unreadEvent:c}=e;const{content:l="",created_at:p=0,id:d,pubkey:u}=t||{},[b,h]=(0,o.useState)(""),[g,x]=(0,o.useState)(""),{nip05:f,picture:m,userName:w}=D(i),v=c?"unread":void 0,{contextMenu:y}=(0,L.H)(),{onContextMenuCapture:k}=(0,o.useMemo)((()=>y?.((()=>[{action:r,icon:"\ud83d\udd10",label:"Start end-to-end encrypted chat"},s.Os,...S(i)]))),[y,r,i]);return(0,o.useEffect)((()=>{l&&A(d,l,i).then((e=>e&&h(e)))}),[l,d,i]),(0,o.useEffect)((()=>{let e=0;return p&&(x(M(p)),e=window.setInterval((()=>x(M(p))),s.qe)),()=>window.clearInterval(e)}),[p,t]),(0,n.jsx)("li",{className:v,onContextMenuCapture:k,children:(0,n.jsx)(T.Z,{onClick:r,children:(0,n.jsx)(q,{nip05:f,picture:m,pubkey:i,userName:w,children:(0,n.jsxs)("div",{children:[(0,n.jsxs)("div",{className:v,children:[u===a?"You: ":"",b||l]}),g?"\xb7":"",(0,n.jsx)("div",{children:g})]})})})})};var te=R.ZP.div.withConfig({componentId:"sc-19191473-0"})`
  display: flex;
  place-items: center;
...
`,re=r(34254);var ne=e=>{let{publicKey:t,recipientPublicKey:r}=e;const{publish:a}=(0,i.Hj)(),s=(0,o.useRef)(null),[c,l]=(0,o.useState)(!1),p=r===d,u=(0,o.useCallback)((async e=>{a(await(async(e,t,r)=>$({content:await j(e,r),created_at:(0,i.wL)(),kind:4,pubkey:t,tags:[["p",r]]}))(e,t,r)),s.current?.value&&(s.current.value=""),l(!1)}),[t,a,r]),b=(0,o.useCallback)((()=>{s.current&&(s.current.style.height="0px",s.current.style.height=`${Math.max(35,s.current.scrollHeight+4)}px`)}),[]);return(0,n.jsxs)(te,{children:[(0,n.jsx)("textarea",{ref:s,disabled:p,onChange:()=>{l(Boolean(s.current?.value)),b()},onKeyDown:async e=>{const{key:t,shiftKey:r}=e,n=s.current?.value.trim();n&&"Enter"===t&&!r?(e.preventDefault(),await u(n)):l(Boolean(n)),b()},placeholder:"Type a message...",autoFocus:!0}),(0,n.jsx)(T.Z,{disabled:p||!c,onClick:()=>s.current?.value&&u(s.current.value),onContextMenuCapture:re.nK,children:(0,n.jsx)(Q,{})})]})},ie=r(71183),oe=r(38060);var ae=(0,R.ZP)(ie.m.ol).withConfig({componentId:"sc-8a58fbcd-0"})`
  ${(0,oe.Z)()}
...
`;var se=R.ZP.div.withConfig({componentId:"sc-8fce322f-0"})`
...
`;var pe=R.ZP.li.withConfig({componentId:"sc-88cfaf69-0"})`
  figure {
    display: flex;
    flex-direction: column;
    place-items: center;
...
`;var de=e=>{let{publicKey:t}=e;const{about:r,nip05:i,picture:o,userName:a}=D(t);return(0,n.jsx)(pe,{children:(0,n.jsxs)(q,{nip05:i,picture:o,pubkey:t,userName:a,children:[r&&(0,n.jsx)("div",{className:"about",children:r}),(0,n.jsxs)("div",{className:"encryption",children:[(0,n.jsx)("span",{children:"\ud83d\udd10 End-to-end encrypted"}),(0,n.jsx)("span",{children:"Messages are secured with AES256-CBC encryption."})]})]})})};var ue=e=>{let{events:t,publicKey:r,recipientPublicKey:i}=e;const a=(0,o.useMemo)((()=>(e=>{if(0===e.length)return[];const t=e.sort(C),[r,...n]=t,i=[[Z(r.created_at),[r]]];return n.forEach((e=>{const{created_at:t}=e,[,r]=i[i.length-1],{created_at:n}=r[r.length-1];Math.abs(t-n)<b?r.push(e):i.push([Z(t),[e]])})),i})(t.filter((e=>{let{pubkey:t,tags:n}=e;const o=t===i,a=y(n)===i;return i===r?o&&a:o||a})))),[t,r,i]),[s,c]=(0,o.useState)({}),l=(0,o.useCallback)((()=>[...a].reverse().forEach((e=>{let[,t]=e;return[...t].reverse().forEach((e=>{let{content:t,id:r}=e;return A(r,t,i).then((e=>c((t=>({...t,[r]:e||!1})))))}))}))),[a,i]),p=(0,o.useRef)(null),u=i===d,{picture:h,userName:g}=D(u?"":i);return(0,o.useEffect)((()=>{a&&(l(),p.current?.scrollTo(0,p.current.scrollHeight))}),[a,l]),(0,n.jsx)(le,{ref:p,children:!u&&(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(de,{publicKey:i}),a.map((e=>{let[t,i]=e;return i.map(((e,i)=>{let{created_at:o,id:a,pubkey:c,content:l}=e;return(0,n.jsxs)("li",{className:(0,re.Wy)({"cant-decrypt":!1===s[a],received:r!==c,sent:r===c}),"data-timestamp":0===i?t:void 0,title:Z(o),children:[r!==c&&(0,n.jsx)("div",{className:"avatar",children:h?(0,n.jsx)("img",{alt:g,src:h}):(0,n.jsx)(H,{})}),(0,n.jsx)("div",{dangerouslySetInnerHTML:{__html:B("string"===typeof s[a]?s[a]:l)}})]},a)}))}))]})})};var be=R.ZP.div.withConfig({componentId:"sc-f764b7f1-0"})`
  input {
    background-color: #242526;
    border-bottom: 1px solid rgb(57, 58, 59);
    color: #fff;
...
`;var he=e=>{let{setRecipientKey:t}=e;return(0,n.jsx)(be,{children:(0,n.jsx)("input",{onKeyDown:e=>{"Enter"===e.key&&e.currentTarget.value&&!t(e.currentTarget.value.trim())&&(e.currentTarget.value="")},placeholder:"Type a Nostr address (npub/nprofile/hex)",spellCheck:!1,type:"text",autoFocus:!0})})},ge=r(51526);var xe=(0,R.ZP)(ie.m.div).withConfig({componentId:"sc-3ef6cbe3-0"})`
  display: flex;
  flex-direction: column;
  height: 100%;
`;const fe=e=>{let{processId:t,loginTime:r,publicKey:c,relayUrls:l,wellKnownNames:p}=e;const[u,b]=(0,o.useState)([]),[h,g]=(0,o.useState)(""),w=(0,o.useCallback)(((e,t)=>g((n=>((n||e)&&t&&b((i=>[...new Set([...t.filter((t=>{let{created_at:i,pubkey:o}=t;return[e,n].includes(o)&&i>r})).map((e=>{let{id:t}=e;return t})),...i])])),e)))),[r]),{contactKeys:v,events:k,lastEvents:A,unreadEvents:j}=((e,t,r,n)=>{const a=(0,o.useMemo)((()=>[...s.PACKAGE_DATA?.author?.npub?new Set([m(s.PACKAGE_DATA.author.npub),...Object.values(t||{})]):Object.values(t||{})].filter(Boolean).map((e=>m(e)))),[t]),c=(0,i.sE)((e=>({enabled:!!e,filter:{"#p":e?[e]:[],kinds:[4]}}))(e)),l=(0,i.sE)((e=>({enabled:!!e,filter:{authors:e?[e]:[],kinds:[4]}}))(e)),p=(0,o.useMemo)((()=>[...c.events,...l.events]),[c,l]),d=(0,o.useMemo)((()=>{const t=new Set(p.sort(E).map((t=>{let{pubkey:r,tags:n}=t;return r===e?y(n)||"":r})).filter((e=>!a.includes(e))));return[...a,...t].filter((t=>t!==e))}),[p,a,e]),u=(0,o.useMemo)((()=>Object.fromEntries(d.map((e=>[e,p.filter((t=>[t.pubkey,y(t.tags)].includes(e))).sort(E)[0]])))),[d,p]),b=(0,o.useMemo)((()=>p.filter((t=>{let{created_at:i,id:o,pubkey:a}=t;return a!==e&&i>r&&!n.includes(o)}))),[p,r,e,n]);return{contactKeys:d,events:p,lastEvents:u,unreadEvents:b}})(c,p,r,u),C=(0,o.useCallback)((e=>{const t=(e=>{const t=e.startsWith("nprofile"),r=e.startsWith("nsec");if(t||r||e.startsWith("npub"))try{const{data:n}=a.uD.decode(e)||{},i=t?n?.pubkey:n;return r?(0,a.$3)(i):i}catch{return""}try{return m(a.uD.npubEncode(e))}catch{return""}})(e);return t&&w(t),Boolean(t)}),[w]),{processes:{[t]:M},url:S}=(0,V.z)(),{url:$}=M||{};return((e,t)=>{const[r,n]=(0,o.useState)(t),{title:i}=(0,V.z)(),[a]=e.split(s.CC);(0,o.useEffect)((()=>{i(a,`${G.Z[a]?.title}${t>0?` (${t})`:""}`)}),[a,i,t]),(0,o.useEffect)((()=>{t>r&&new Audio("/Program Files/Messenger/notification.mp3").play(),n(t)}),[r,t])})(t,j.length),(0,o.useEffect)((()=>{if(!$||!$.startsWith("nostr:npub")&&!$.startsWith("nostr:nprofile"))return;const[,e]=$.split("nostr:");if(e){const r=m(e);e!==r&&(g(r),S(t,""))}}),[t,S,$]),(0,o.useEffect)((()=>{j&&h&&j.filter((e=>{let{pubkey:t}=e;return t===h})).forEach((e=>{let{id:t}=e;return b((e=>[...new Set([t,...e])]))}))}),[h,j]),(0,n.jsx)(U,{children:(0,n.jsxs)(O,{children:[(0,n.jsx)(ce,{goHome:()=>w("",k),newChat:()=>w(d),publicKey:c,relayUrls:l,selectedRecipientKey:h}),(0,n.jsx)("div",{children:(0,n.jsx)(ge.M,{initial:!1,presenceAffectsLayout:!1,children:h?(0,n.jsxs)(xe,{...f,children:[h===d&&(0,n.jsx)(he,{setRecipientKey:C}),(0,n.jsx)(ue,{events:k,publicKey:c,recipientPublicKey:h}),(0,n.jsx)(ne,{publicKey:c,recipientPublicKey:h})]},"chat"):(0,n.jsx)(ae,{onContextMenu:re.nK,...x,children:v.map((e=>(0,n.jsx)(ee,{lastEvent:A[e],onClick:()=>w(e,k),pubkey:e,publicKey:c,unreadEvent:j.includes(A[e])},e)))},"contacts")})})]})})};var me=e=>{let{id:t}=e;const[r,a]=(0,o.useState)(0),[s,l]=(0,o.useState)(),p=(0,o.useRef)(!1),{names:d}=(()=>{const[e,t]=(0,o.useState)(),r=(0,o.useCallback)((async e=>{const r=await fetch(e);if(r.ok){const{names:e={}}=await r.json()||{};t({names:e})}return r.ok}),[]),n=(0,o.useCallback)((async()=>{await r(u)||t({relays:{}})}),[r]);return(0,o.useEffect)((()=>{e||n()}),[n,e]),e||{}})(),b=J();return(0,o.useEffect)((()=>{!p.current&&b&&(p.current=!0,(async()=>window.nostr?.getRelays?[...new Set([...c,...Object.entries(await window.nostr.getRelays()).map((e=>{let[t]=e;return t.endsWith("/")?t.slice(0,-1):t}))])]:c)().then((e=>{l(e),a(Math.floor(Date.now()/1e3))})))}),[b]),b&&s?(0,n.jsx)(i.gF,{relayUrls:s,children:(0,n.jsx)(fe,{loginTime:r,processId:t,publicKey:b,relayUrls:s,wellKnownNames:d})}):(0,n.jsx)(n.Fragment,{children:" "})}},38060:function(e,t,r){r.d(t,{Z:function(){return p}});var n=r(10508);const i="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAYAAAAf8/9hAAAAKElEQVR42mOgMRgF6enp/ynSDMMUaEZgsjST5RJsikk2AKc4bcAoAADI7y5FsB5j/QAAAABJRU5ErkJggg==",o="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAYAAAAf8/9hAAAAK0lEQVR42mOgARgF6enp/0kRZ8KvGMEnyQUwjMwn0xBMzWQZQlmA0h6MAgAuqCnfdOk/ZQAAAABJRU5ErkJggg==",a="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAYAAAAf8/9hAAAAG0lEQVR42mPAD0ZBenr6fxge4ppHuiGEwSgAAGJiLkXUVlYDAAAAAElFTkSuQmCC",s="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAYAAAAf8/9hAAAAG0lEQVR42mPADkZBenr6fxgeZoYMV82Ug1EAAPiTLkWjutmQAAAAAElFTkSuQmCC";var c=r(64358);const l={dark:{active:"rgb(166, 166, 166)",blendMode:"color-burn",buttonHover:"rgb(55, 55, 55)",thumb:"rgb(77, 77, 77)",thumbHover:"rgb(122, 122, 122)",track:"rgb(23, 23, 23)"},light:{active:"rgb(96, 96, 96)",blendMode:"color-dodge",buttonHover:"rgb(218, 218, 218)",thumb:"rgb(205, 205, 205)",thumbHover:"rgb(166, 166, 166)",track:"rgb(240, 240, 240)"}};var p=function(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:c.BQ,t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:0,r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:0,p=arguments.length>3&&void 0!==arguments[3]?arguments[3]:"dark";return n.iv`
  overflow: auto;
  scrollbar-color: ${l[p].thumb} ${l[p].track};
  ...
  &::-webkit-scrollbar-track {
    background-color: ${l[p].track};
  }

  &::-webkit-scrollbar-thumb {
    background-clip: padding-box;
    background-color: ${l[p].thumb};
  }
  ...
  &::-webkit-scrollbar-thumb:hover {
    background-color: ${l[p].thumbHover};
  }

  &::-webkit-scrollbar-thumb:active {
    background-color: ${l[p].active};
  }
  ...
  &::-webkit-scrollbar-button:single-button {
    ...
    border: 1px solid ${l[p].track};
    display: block;
    height: ${e?`${e}px`:"initial"};

    &:hover {
      background-color: ${l[p].buttonHover};
    }
  ...
  &::-webkit-scrollbar-button:single-button:horizontal:increment:active {
    background-blend-mode: ${l[p].blendMode};
  }
`}}}]);