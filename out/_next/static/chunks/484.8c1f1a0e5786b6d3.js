...
`,B=n(13645),S=n(19682),E=(0,i.forwardRef)(((e,t)=>{let{hideSearch:n,id:a}=e;const{url:l,processes:{[a]:{url:A=""}}}=(0,d.z)(),u="/"===A?"":(0,o.basename)((0,o.dirname)(A)),{contextMenu:h}=(0,c.H)(),{canGoBack:m,canGoForward:w,history:b,moveHistory:v,position:E}=(0,S.Z)(A,a),{onContextMenuCapture:j}=(0,i.useMemo)((()=>h?.((()=>b.map(((e,t)=>({action:()=>v(t-E),checked:E===t,label:(0,o.basename)(e)||g.SP,primary:E===t}))).reverse()))),[h,b,v,E]);return(0,r.jsxs)(k,{...(0,B.Z)(a),onDragOver:x.nK,onDrop:x.nK,children:[(0,r.jsx)(p.Z,{disabled:!m,onClick:()=>v(-1),...(0,x.PS)(m?`Back to ${(0,o.basename)(b[E-1])||g.SP}`:"Back"),children:(0,r.jsx)(s.Back,{})}),(0,r.jsx)(p.Z,{disabled:!w,onClick:()=>v(1),...(0,x.PS)(w?`Forward to ${(0,o.basename)(b[E+1])||g.SP}`:"Forward"),children:(0,r.jsx)(s.Forward,{})}),(0,r.jsx)(p.Z,{disabled:1===b.length,onClick:j,...(0,x.PS)("Recent locations"),children:(0,r.jsx)(s.Down,{})}),(0,r.jsx)(p.Z,{disabled:"/"===A,onClick:()=>l(a,(0,o.dirname)(A)),...(0,x.PS)("/"===A?"Up one level":`Up to "${""===u?g.SP:u}"`),children:(0,r.jsx)(s.Up,{})}),(0,r.jsx)(f,{ref:t,id:a}),!n&&(0,r.jsx)(C,{id:a})]})})),j=n(26753),R=n(62392),y=n(1347),z=a.ZP.div.withConfig({componentId:"sc-278f846e-0"})`
  ${y.Z} {
    column-gap: 2px;
