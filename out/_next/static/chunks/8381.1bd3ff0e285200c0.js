...
`,w=n(7459),b=n(26724),x=n(56758),v=n(30663),y=n(34254);const k=(0,s.memo)((()=>(0,i.jsx)("svg",{viewBox:"0 0 16 16",xmlns:"http://www.w3.org/2000/svg",children:(0,i.jsx)("path",{clipRule:"evenodd",d:"m13.353 1.146 1.5 1.5L15 3v11.5l-.5.5h-13l-.5-.5v-13l.5-.5H13l.353.146zM2 2v12h12V3.208L12.793 2H11v4H4V2H2zm6 0v3h2V2H8z",fillRule:"evenodd"})})));var C=e=>{let{id:t}=e;const{processes:{[t]:n}}=(0,x.z)(),{editor:a,url:r}=n||{},{updateFolder:l,writeFile:c}=(0,b.o)(),{prependFileToTitle:d}=(0,w.Z)(t),[p,h]=(0,s.useState)(""),[C,L]=(0,s.useState)("Ln 1, Col 1"),[$,j]=(0,s.useState)(1);return(0,s.useEffect)((()=>{const e=()=>{const e=a?.getSelection(),{positionColumn:t=0,positionLineNumber:n=0}=e||{},i=e?a?.getModel()?.getValueInRange(e):"";L(`Ln ${n}, Col ${t}${i?` (${i.length} selected)`:""}`)},t=()=>j(a?.getModel()?.getLineCount()||0);a?.onDidChangeModelContent(t),a?.onDidChangeCursorPosition(e),a?.onDidChangeModel((()=>{const n=a?.getModel(),i=n?.getLanguageId();i&&h(window.monaco?.languages.getLanguages().reduce(((e,t)=>{let{id:n,aliases:o}=t;return n===i&&o?.[0]||e}),i)),t(),e()}))}),[a]),(0,i.jsx)(m,{onContextMenuCapture:y.nK,children:a&&(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)("ol",{children:(0,i.jsxs)("li",{children:["Lines ",$]})}),(0,i.jsxs)("ol",{children:[(0,i.jsx)("li",{className:"clickable",id:"save",children:(0,i.jsx)(v.Z,{onClick:async()=>{const[e,t]=u(r,a);e&&t&&(await c(e,t,!0),l((0,o.dirname)(e),(0,o.basename)(e)),d((0,o.basename)(e)))},...(0,y.PS)("Save"),children:(0,i.jsx)(k,{})})}),r&&g(p)&&(0,i.jsx)("li",{className:"clickable",children:(0,i.jsx)(v.Z,{className:"pretty",onClick:async()=>a?.setValue(await f(p,a.getValue())),...(0,y.PS)(`Pretty print ${(0,o.basename)(r)}`),children:"{ }"})}),C&&(0,i.jsx)("li",{className:"clickable",children:(0,i.jsx)(v.Z,{onClick:()=>{try{a?.focus(),a?.getAction("editor.action.gotoLine")?.run()}catch{}},...(0,y.PS)("Go to Line/Column"),children:C})}),""!==p&&(0,i.jsx)("li",{children:p})]})]})})};const L=h.ZP.div.withConfig({componentId:"sc-792c2bb4-0"})`
